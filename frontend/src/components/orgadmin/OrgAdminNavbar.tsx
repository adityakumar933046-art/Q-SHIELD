  ...
  return (
    <header className="h-16 bg-[#0B1220]/90 border-b border-[#1F2E4D] px-6 flex items-center justify-between sticky top-0 z-20 backdrop-blur-md font-sans">
      <div className="flex items-center space-x-3">
        ...
        <span className="hidden md:inline-flex items-center space-x-1.5 px-2.5 py-0.5 bg-purple-500/10 border border-purple-500/30 rounded-full text-[10px] font-sans text-purple-400 font-bold">
      ...
      <div className="flex items-center space-x-4">
        ...
        <div className="flex items-center space-x-3 pl-2 border-l border-[#1F2E4D]">
          <div className="w-8 h-8 rounded-full bg-gradient-to-tr from-purple-600 to-[#00C2FF] flex items-center justify-center text-white font-bold text-xs font-sans shadow-md">
