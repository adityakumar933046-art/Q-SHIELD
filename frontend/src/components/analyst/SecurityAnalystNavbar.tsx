  ...
  return (
    <header className="h-16 bg-[#0B1220]/90 border-b border-[#1F2E4D] px-6 flex items-center justify-between sticky top-0 z-20 backdrop-blur-md font-sans">
      <div className="flex items-center space-x-3">
        ...
        <span className="hidden md:inline-flex items-center space-x-1.5 px-2.5 py-0.5 bg-[#EF4444]/10 border border-[#EF4444]/30 rounded-full text-[10px] font-mono text-[#EF4444]">
      ...
      <div className="flex items-center space-x-4">
        ...
        <div className="hidden sm:flex items-center space-x-2 px-3 py-1 bg-[#EF4444]/10 border border-[#EF4444]/30 rounded-xl text-xs font-mono text-[#EF4444]">
        ...
        <div className="flex items-center space-x-3 pl-2 border-l border-[#1F2E4D]">
          <div className="w-8 h-8 rounded-full bg-gradient-to-tr from-[#EF4444] to-purple-600 flex items-center justify-center text-white font-black text-xs font-mono shadow-md">
