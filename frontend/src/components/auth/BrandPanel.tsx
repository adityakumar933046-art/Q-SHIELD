    ...
    <div className="h-full bg-gradient-to-br from-[#070C16] via-[#0B1220] to-[#0D182E] border-r border-[#1F2E4D]/80 p-8 lg:p-12 flex flex-col justify-between relative overflow-hidden font-sans">
      ...
      <div className="relative z-10 space-y-4">
        <div className="flex items-center space-x-3.5">
          ...
          <div>
            <h1 className="text-2xl font-bold tracking-tight text-white">Q-SHIELD</h1>
            <p className="text-xs font-semibold text-[#00C2FF] uppercase tracking-wider">
              Enterprise Cyber Security
            </p>
          </div>
        </div>

        <p className="text-slate-400 text-xs font-normal max-w-md leading-relaxed">
      ...
      <div className="relative z-10 my-8 py-6 flex flex-col items-center justify-center">
        <div className="relative w-64 h-64 flex items-center justify-center">
          ...
          <div className="p-6 bg-[#070C16] border-2 border-[#00C2FF] rounded-3xl text-[#00C2FF] shadow-2xl backdrop-blur-md flex flex-col items-center justify-center space-y-1">
            ...
            <span className="text-xs font-semibold text-white tracking-wider uppercase">QDS Engine</span>
          </div>
        </div>
      </div>
      ...
      <div className="relative z-10 space-y-4">
        ...
        <div className="flex items-center justify-between text-xs text-slate-400 font-normal">
          <span className="flex items-center space-x-1.5">
            ...
            <span className="text-slate-300 font-semibold">Quantum Telemetry Online</span>
          </span>
