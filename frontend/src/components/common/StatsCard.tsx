...
export const StatsCard: React.FC<StatsCardProps> = ({
  ...
  return (
    <div className="bg-[#0B1220]/90 border border-[#1F2E4D] rounded-xl p-5 shadow-lg backdrop-blur-md relative overflow-hidden group hover:border-[#00C2FF]/40 transition duration-200">
      ...
      {description && (
        <p className="text-[11px] text-slate-400 mt-2 font-mono">{description}</p>
      )}
    </div>
  );
};
