    ...
    <div className="space-y-6 font-sans">
      ...
      <div className="bg-[#0B1220] border border-[#1F2E4D] rounded-2xl p-6 shadow-xl flex flex-col md:flex-row md:items-center justify-between gap-4">
        <div className="flex items-center space-x-3">
          ...
          <div>
            <h2 className="text-xl font-extrabold text-white">Platform System Audit Logs</h2>
        ...
        <button
          ...
          className="px-3.5 py-2 bg-[#131E33] hover:bg-[#1F2E4D] text-[#00C2FF] font-mono font-bold text-xs rounded-xl border border-[#1F2E4D] transition flex items-center space-x-2 shrink-0"
        >
        ...
        <div className="flex flex-wrap items-center gap-3 w-full md:w-auto justify-end">
          ...
          <div className="flex items-center space-x-2 text-xs font-mono text-slate-400">
            ...
            <select
              ...
              className="bg-[#131E33] border border-[#1F2E4D] text-xs text-white rounded-xl px-3 py-1.5 focus:outline-none focus:border-[#00C2FF] font-mono"
            >
