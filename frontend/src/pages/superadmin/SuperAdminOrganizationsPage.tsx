      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 bg-[#0B1220] border border-[#1F2E4D] rounded-2xl p-6 shadow-xl">
        <div>
          <div className="flex items-center space-x-3">
            ...
            <div>
              <h2 className="text-xl font-extrabold text-white">Platform Organizations Directory</h2>
        ...
        <button
          ...
          className="px-4 py-2.5 bg-[#00C2FF] hover:bg-[#00A8DE] text-[#0B1220] font-extrabold text-xs rounded-xl shadow-lg transition flex items-center space-x-2 shrink-0"
        >
              ...
              <tbody className="divide-y divide-[#1F2E4D]/50 text-slate-200">
                {filteredOrgs.map((org) => (
                  <tr key={org.id} className="hover:bg-[#131E33]/50 transition">
                    ...
                    <td className="py-4 px-4 text-slate-300 font-mono">{org.domain || 'qshield.gov'}</td>
