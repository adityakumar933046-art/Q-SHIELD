...
export const AnalyticsPage: React.FC = () => {
  ...
  if (loading) {
    return <div className="p-8 text-center text-slate-500 font-mono">Loading Statistical Physics Analytics...</div>;
  }
    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        <div className="bg-white border border-[#E2E8F0] rounded-xl p-5 space-y-2 shadow-sm">
          ...
          <div className="text-2xl font-extrabold text-[#00C2FF] font-mono">&alpha; = 0.05</div>
        ...
        <div className="bg-white border border-[#E2E8F0] rounded-xl p-5 space-y-2 shadow-sm">
          ...
          <div className="text-2xl font-extrabold text-[#0B1220] font-mono">p0=0.01 / p1=0.11</div>
        ...
        <div className="bg-white border border-[#E2E8F0] rounded-xl p-5 space-y-2 shadow-sm">
          ...
          <div className="text-2xl font-extrabold text-[#10B981] font-mono">P &le; 0.05</div>
      ...
      <div className="bg-white border border-[#E2E8F0] rounded-xl p-5 space-y-4 shadow-sm">
        <div className="flex justify-between items-center">
          ...
          <span className="text-xs text-[#10B981] font-mono font-bold">&ge; 85.0% Security Limit</span>
        </div>
