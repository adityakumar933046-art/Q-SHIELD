    ...
    <div className="space-y-6 font-sans">
      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 bg-[#0B1220] border border-[#1F2E4D] rounded-2xl p-6 shadow-xl">
        <div className="flex items-center space-x-3">
          ...
          <div>
            <h2 className="text-xl font-bold text-white">Threat Monitoring Directory</h2>
      ...
      <div className="space-y-2">
        <span className="text-[11px] font-sans font-bold text-slate-400 uppercase tracking-wider block px-1">
          ...
          {attackCategories.map((cat) => {
            ...
            return (
              <button
                ...
                className={`p-3.5 rounded-2xl border transition-all text-left font-sans relative overflow-hidden group ${
                  isSelected
              ...
              >
                ...
                <h4 className="text-xs font-bold text-white truncate group-hover:text-[#00C2FF] transition">
                  {cat.name}
                </h4>
      ...
      <div className="bg-[#0B1220]/90 border border-[#1F2E4D] rounded-2xl p-4 flex flex-col md:flex-row items-center justify-between gap-4 backdrop-blur-md">
        <div className="relative w-full md:w-96">
          ...
          <input
            ...
            className="w-full bg-[#131E33] border border-[#1F2E4D] rounded-xl pl-10 pr-4 py-2 text-xs text-white placeholder-slate-500 focus:outline-none focus:border-[#EF4444] font-sans"
          />
        </div>
              ...
              <tbody className="divide-y divide-[#1F2E4D]/50 text-slate-200">
                {filteredThreats.map((threat) => (
                  <tr key={threat.id || threat.incident_number} className="hover:bg-[#131E33]/50 transition">
                    ...
                    <td className="py-4 px-4 text-slate-300 font-sans text-[11px]">
