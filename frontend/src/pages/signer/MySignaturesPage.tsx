    ...
    <div className="space-y-6 font-sans">
      ...
      <div className="bg-[#0B1220] border border-[#1F2E4D] rounded-2xl p-6 shadow-xl flex flex-col md:flex-row md:items-center justify-between gap-4">
        <div className="flex items-center space-x-3">
          ...
          <div>
            <h2 className="text-xl font-extrabold text-white">My Quantum Digital Signatures</h2>
        ...
        <div className="flex items-center space-x-3 shrink-0">
          <button
            ...
            className="px-3.5 py-2.5 bg-[#131E33] hover:bg-[#1F2E4D] text-[#00C2FF] font-mono font-bold text-xs rounded-xl border border-[#1F2E4D] transition flex items-center space-x-2"
          >
          ...
          <Link
            ...
            className="px-4 py-2.5 bg-[#00C2FF] hover:bg-[#00A8DE] text-[#0B1220] font-extrabold font-mono text-xs rounded-xl shadow-lg transition flex items-center space-x-2"
          >
      ...
      <div className="bg-[#0B1220]/90 border border-[#1F2E4D] rounded-2xl p-4 flex flex-col md:flex-row items-center justify-between gap-4 backdrop-blur-md">
        <div className="relative w-full md:w-80">
          ...
          <input
            ...
            className="w-full bg-[#131E33] border border-[#1F2E4D] rounded-xl pl-10 pr-4 py-2 text-xs text-white placeholder-slate-500 focus:outline-none focus:border-[#00C2FF] font-mono"
          />
        </div>
