        ...
        <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 relative z-10">
          <div>
            <div className="flex items-center space-x-2 mb-1">
              <span className="px-2.5 py-0.5 bg-[#00C2FF]/10 border border-[#00C2FF]/30 rounded-full text-[10px] font-sans text-[#00C2FF] font-bold uppercase">
          ...
          <div className="flex items-center space-x-3">
            <Link
              ...
              className="px-4 py-2.5 bg-[#00C2FF] hover:bg-[#00A8DE] text-[#0B1220] font-bold text-xs rounded-xl shadow-lg transition flex items-center space-x-2"
            >
      ...
      <div className="bg-[#0B1220]/90 border border-[#1F2E4D] rounded-2xl p-6 shadow-xl backdrop-blur-md">
        <div className="flex items-center justify-between mb-4">
          <div className="flex items-center space-x-2">
            ...
            <h3 className="text-base font-bold text-white">Recent Signatures Created</h3>
          </div>
