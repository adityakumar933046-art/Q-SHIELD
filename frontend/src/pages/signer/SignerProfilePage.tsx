...
import { User as UserIcon, Mail, Building2, ShieldCheck, Lock, Activity, Smartphone } from 'lucide-react';
import { StatusBadge } from '../../components/common/StatusBadge';
import { LoadingState } from '../../components/common/LoadingState';
import { api } from '../../services/api';
import { User } from '../../types';

interface SignerProfilePageProps {
  currentUser: User | null;
}

export const SignerProfilePage: React.FC<SignerProfilePageProps> = ({ currentUser }) => {
  ...
  if (loading) {
    return <LoadingState message="Loading your Signer credentials and organization profile..." />;
  }
          ...
          <div className="space-y-3">
            ...
            <div className="p-4 bg-[#131E33] border border-[#1F2E4D] rounded-xl space-y-3 font-sans text-xs">
              ...
              <div className="flex justify-between border-b border-[#1F2E4D]/40 pb-2">
                ...
                <span className="font-bold text-[#00C2FF]">{user?.department || 'QDS Teleportation Lab'}</span>
              </div>
            ...
            <div className="p-4 bg-[#10B981]/10 border border-[#10B981]/30 rounded-xl text-xs font-sans text-[#10B981] flex items-start space-x-3">
              ...
              <div>
                ...
                <p className="text-[11px] text-slate-300 leading-relaxed">
                  Your Signer account is protected by mandatory 2FA TOTP and Step-Up authentication for document signature generation.
                </p>
              </div>
            </div>
          </div>
