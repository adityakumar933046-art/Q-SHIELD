    ...
    <div className="space-y-8 max-w-4xl font-sans">
      ...
      <div className="bg-[#0B1220] border border-[#1F2E4D] rounded-2xl p-6 shadow-xl flex items-center justify-between">
        <div className="flex items-center space-x-3">
          ...
          <div>
            <h2 className="text-xl font-extrabold text-white">Verifier Credentials Profile</h2>
      ...
      <div className="grid grid-cols-1 md:grid-cols-12 gap-8">
        ...
        <div className="md:col-span-4 bg-[#0B1220]/90 border border-[#1F2E4D] rounded-2xl p-6 shadow-xl backdrop-blur-md text-center space-y-4">
          <div className="w-20 h-20 rounded-full bg-gradient-to-tr from-[#10B981] to-[#00C2FF] border-2 border-[#10B981]/40 text-white font-black text-2xl font-mono flex items-center justify-center shadow-xl mx-auto">
          ...
          <div>
            ...
            <div className="mt-2">
              <span className="px-2.5 py-0.5 bg-[#10B981]/10 text-[#10B981] border border-[#10B981]/30 text-[10px] font-mono font-bold rounded uppercase tracking-wider">
                VERIFIER ROLE
              </span>
            </div>
          </div>
