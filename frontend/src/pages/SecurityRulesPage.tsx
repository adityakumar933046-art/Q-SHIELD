...
export const SecurityRulesPage: React.FC = () => {
  ...
  if (loading) {
    return <div className="p-8 text-center text-slate-500 font-mono">Loading Security Threshold Configuration...</div>;
  }
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="bg-[#0B1220] border border-[#1A263D] rounded-xl p-6 flex flex-col md:flex-row items-start md:items-center justify-between shadow-md text-white">
        <div className="space-y-1">
          <div className="flex items-center space-x-3">
            ...
            <h1 className="text-xl font-extrabold tracking-wide">Security Rules & Statistical Threshold Configuration</h1>
          </div>
        ...
        <div className="mt-4 md:mt-0 flex items-center space-x-2 bg-[#131E33] px-3.5 py-1.5 rounded-lg border border-[#1F2E4D] text-xs font-mono text-[#00C2FF] font-bold">
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
        <div className="bg-white border border-[#E2E8F0] rounded-xl p-4 space-y-1 shadow-sm font-mono">
          <span className="text-[11px] text-slate-500 font-semibold font-sans uppercase">QBER Maximum Limit</span>
          <div className="text-xl font-extrabold text-[#F59E0B]">&le; 11.00%</div>
        ...
        <div className="bg-white border border-[#E2E8F0] rounded-xl p-4 space-y-1 shadow-sm font-mono">
          ...
          <div className="text-xl font-extrabold text-[#10B981]">&ge; 85.00%</div>
        ...
        <div className="bg-white border border-[#E2E8F0] rounded-xl p-4 space-y-1 shadow-sm font-mono">
          ...
          <div className="text-xl font-extrabold text-[#00C2FF]">&alpha; = 0.05</div>
        ...
        <div className="bg-white border border-[#E2E8F0] rounded-xl p-4 space-y-1 shadow-sm font-mono">
          ...
          <div className="text-xl font-extrabold text-[#0B1220]">p0=0.01 / p1=0.11</div>
          ...
          {rules.map((rule) => (
            <div key={rule.id} className="bg-[#F8FAFC] border border-[#E2E8F0] rounded-xl p-4 space-y-3">
              <div className="flex justify-between items-start">
                <div className="space-y-1">
                  <span className="text-[10px] font-mono text-[#00C2FF] uppercase font-bold">{rule.metric_type} EVALUATOR</span>
              ...
              <div className="bg-white p-3 rounded-lg border border-[#E2E8F0] font-mono text-xs flex justify-between items-center">
